 ...
 *
 * @author WangChen
 * Created on 2019/7/24 20:07
 * @since 1.0
 */
public class TextMarkupAnnotationTest {

    public static final String DEST = "src/main/resources/file/pdf/interactive/TextMarkupAnnotationTest.pdf";
