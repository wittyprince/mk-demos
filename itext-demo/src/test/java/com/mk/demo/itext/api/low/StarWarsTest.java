 ...
 *
 * @author WangChen
 * Created on 2019/7/23 22:05
 * @since 1.0
 */
public class StarWarsTest {

    public static final String DEST = "src/main/resources/file/pdf/api/low/StarWarsTest.pdf";
    ...
    public void createPdf(String dest) throws IOException {
        ...
        System.out.println("page height: " + ps.getHeight());
        canvas.beginText()
                .setFontAndSize(PdfFontFactory.createFont(FontConstants.COURIER_BOLD), 14)
                .setLeading(14 * 1.2f)
                .moveText(70, -40);// the cursor moves 70 user units to the right and 40 user units down.
        for (String s : text) {
