package com.mk.demos.design.proxy.fromother;
...
import com.mk.demos.design.pattern.proxy.fromother.cglib.CglibMethodInterceptor;
import com.mk.demos.design.pattern.proxy.fromother.cglib.Dog;
...
public class CglibTest {
    ...
    public void testCglib() throws Exception {
        ...
        dog = (Dog) cglibMethodInterceptor.CglibProxyGenerator(Dog.class);
        System.out.println(dog.bark());
    }
