 ...
 *
 * @author WangChen
 * Created on 2021/1/15 16:27
 * @since 1.0
 */
public class JdkDynamicProxyTest {
    public static void main(String[] args) throws Exception {
        // 打开保存JDK动态代理生成的类文件
//        saveGeneratedJdkProxyFiles();// 没明白这行作用？？？
        /**
        ...
        System.out.println(
                "代理类信息: " +
                        "\n  package = " + personProxy.getClass().getPackage() +
        ...
        // 通过 代理类 执行 委托类的代码逻辑
        personProxy.goWorking(person.getName(), "深圳");
        ...
        Person person2 = new SoftwareEngineer("Vincent");
        InvocationHandler handler2 = new PersonInvocationHandler<>(person2, 2L);
        ...
        Person stuProxy = (Person) ProxyConstructor.newInstance(handler2);
        /** 检测生成的类是否是代理类 */
        ...
        System.out.println("handlerObject:" + handlerObject.getClass().toString());
        stuProxy.goWorking(stuProxy.getName(), "广州");
        // 保存代理類
        saveClass("$PersonProxy0", proxyClass.getInterfaces(), "D:/tmp/");
    }
