package com.mk.demos.spring.cloud.gataway.predicate;
...
public class CustomReadBodyRoutePredicateFactory extends AbstractRoutePredicateFactory<CustomReadBodyRoutePredicateFactory.Config> {
    ...
    private Logger logger = LoggerFactory.getLogger(CustomReadBodyRoutePredicateFactory.class);
    ...
    private void overrideMsgReaders() {
        this.messageReaders = HandlerStrategies
                .builder()
            ...
            public Publisher<Boolean> apply(ServerWebExchange exchange) {
                ...
                if (cachedBody != null) {
                    try {
                        ...
                        logger.debug("Predicate test failed because class in predicate does not match the cached body object", var6);
                    ...
                    return ServerWebExchangeUtils.cacheRequestBodyAndRequest(exchange, (serverHttpRequest) -> {
                        return ServerRequest
                                .create(exchange.mutate().request(serverHttpRequest).build(),
                                        CustomReadBodyRoutePredicateFactory.this.messageReaders)
